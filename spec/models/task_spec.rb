...
describe Task do
  it "doesnt add validations to ignored columns" do
    ...
    default_function_presence_validation = Task.validators_on(:token).find { |validator| validator.kind == :presence }
    ...
    expect(default_function_presence_validation).to be_nil
  end
end
